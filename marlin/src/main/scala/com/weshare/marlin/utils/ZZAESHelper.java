 ...
 * @since 2016-10-22
 */
public class ZZAESHelper {
    private static final Logger logger = LoggerFactory.getLogger(ZZAESHelper.class);
    ...
    private String decrypt(final String varEncKey, final String content) {
        try {
            final Cipher cipher = getCipher();
            byte[] aesKeys = getAesCipherKey(keyValue, varEncKey);
